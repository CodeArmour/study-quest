...
import { Clock, Edit, X, ArrowUp, ArrowDown } from "lucide-react"
...
export function NoteItem({ note, onUpdate, onDelete, onMoveUp, onMoveDown, isFirst, isLast }: NoteItemProps) {
  ...
  const handleKeyDown = (e) => {
    ...
    if (e.key === "Enter" && !e.shiftKey) {
      e.stopPropagation() // Don't submit the form
    }
  }
